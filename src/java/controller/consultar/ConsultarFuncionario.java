...
public class ConsultarFuncionario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int codigoFuncionario = Integer.parseInt(request.getParameter("codigoFuncionario"));
            FuncionarioDAO funcionarioDAO = new FuncionarioDAO();
            request.setAttribute("funcionario", funcionarioDAO.consultar(codigoFuncionario));
