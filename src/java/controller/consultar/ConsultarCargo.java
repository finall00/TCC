 ...
 * @author smili08
 */
@WebServlet(name = "ConsultarCargo", urlPatterns = {"/ConsultarCargo"})
public class ConsultarCargo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("cargo", cargoDAO.consultar(codigoCargo));
