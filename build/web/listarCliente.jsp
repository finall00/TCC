                ...
                <table class="content-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a class="alter" href="ConsultarCliente?codigoCliente=<%= cliente.getCodigoPessoa()%>">Mais</a></td>
                            <td><a class="delete" href="ExcluirCliente?codigoCliente=<%= cliente.getCodigoPessoa()%>">Excluir</a></td>
                        </tr>
                    </tbody>
                    <%}%>
                </table>
